...
public class DefaultTokenValueImpl implements TokenValue {
	...
	public DefaultTokenValueImpl(TokenDefinition definition, Object value) {
		if (definition == null)
		...
		if (displayValue == null) {
			if (isXable) {
				...
				if (value instanceof String) {
					displayValue =
							RomanNumberFactory.getUpperCaseString(Integer
				...
				Number num = (Number) value;
				if ((num.intValue() >= 0 || num.doubleValue() >= 0)
						&& !StringUtils.left(name, 2).equals("is")) {
