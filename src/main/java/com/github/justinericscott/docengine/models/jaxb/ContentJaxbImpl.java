...
public class ContentJaxbImpl extends AbstractModelJaxbImpl {
	...
	public ContentJaxbImpl(ContentJaxbImpl content) {
	...
	public ContentJaxbImpl(ContentJaxbImpl content, String contentCd) {
		this(content);
