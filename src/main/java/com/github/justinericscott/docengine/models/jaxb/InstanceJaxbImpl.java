...
public class InstanceJaxbImpl extends AbstractModelJaxbImpl {
	...
	private ContentJaxbImpl content;
	...
	public InstanceJaxbImpl(ContentJaxbImpl content) {
		this();
		this.content = content;
		this.orderBy = content.getOrderBy();
	}

	public InstanceJaxbImpl(ContentJaxbImpl content, String projectId) {
		this(content);
		this.projectId = projectId;
	}

	public InstanceJaxbImpl(ContentJaxbImpl content, String projectId, String body) {
	...
	public ContentJaxbImpl getContent() { return content; }
	public void setContent(ContentJaxbImpl contentJaxbImpl) { this.content = contentJaxbImpl; }
