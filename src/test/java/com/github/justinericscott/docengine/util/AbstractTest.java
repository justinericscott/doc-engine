...
public class AbstractTest {
	...
	//
	// public static final Class<?> TEST_CLASS_ANNOTATED =
	// ExampleExcelType.class;
	// public static final Class<?> TEST_CLASS_CUSTOM_LABELS =
	// ExampleExcelTypeWithCustomLabels.class;
	// public static final Class<?> TEST_CLASS_CUSTOM_LABELS_ORDERED =
	// ExampleExcelTypeWithCustomLabelsOrdered.class;
	// public static final Class<?> TEST_CLASS_CUSTOM_LABELS_ORDERED_REVERSED =
	// ExampleExcelTypeWithCustomLabelsOrderedReversed.class;
	// public static final Class<?> TEST_CLASS_CUSTOM_LABELS_ORDERED_UNORDERED =
	// ExampleExcelTypeWithCustomLabelsOrderedUnordered.class;
	// public static final Class<?> TEST_CLASS_NO_ANNOTATION =
	// NoAnnotationType.class;
	//
	...
	// public static final String TEST_CODE_PREFIX_CONTENT =
	// "TEST_CONTENT_CODE_";
	// public static final String TEST_CODE_PREFIX_DOCUMENT =
	// "TEST_DOCUMENT_CODE_";
	// public static final String TEST_CODE_PREFIX_PARAGRAPH =
	// "TEST_PARAGRAPH_CODE_";
	// public static final String TEST_CODE_PREFIX_SECTION =
	// "TEST_SECTION_CODE_";
	// public static final String TEST_CODE_PREFIX_TOKEN = "TEST_TOKEN_CODE_";
	//
	// public static final String TEST_CSS_VALUE_CLAUSE =
	// read(get("css/clause.css"));
	// public static final String TEST_CSS_VALUE_PARAGRAPH =
	// read(get("css/paragraph.css"));
	// public static final String TEST_CSS_VALUE_SECTION =
	// read(get("css/section.css"));
	//
	// public static final Collection<ExampleExcelTypeWithCustomLabelsOrdered>
	...
	// public static final String TEST_EXP_SECTION_TWO_CLAUSES_NO_PARAGRAPHS =
	// read(
	// get("models/SectionExpectedOutput_TwoClausesNoParagraphs.html"));
	// public static final String
	// TEST_EXP_SECTION_TWO_CLAUSES_TWO_PARAGRAHS_EACH = read(
	...
	// public static final String TEST_EXP_PARAGRAPH_NO_SUBS =
	// read(get("models/ParagraphExpectedOutput_NoSubs.html"));
	...
	// public static final String[] TEST_FIELD_NAMES = { TEST_FIELD_NAME_ID,
	// TEST_FIELD_NAME_NAME,
	// TEST_FIELD_NAME_DESCRIPTION, TEST_FIELD_NAME_POSITIVE };
	// public static final String[] TEST_FIELD_LABELS = { "Identification",
	// "Name", "Description", "Positive" };
	// public static final Object[] TEST_FIELD_VALUES = { 111L, "Test Name",
	// "Test Description", new Boolean(true) };
	//
	// public static final String TEST_FILE_EXPORT =
	// "target/content-export.xlsx";
	// public static final String TEST_FILE_IMPORT = "ix/content-import.xlsx";
	// public static final String TEST_FILE_NAME_READ =
	// "ix/test-data-read.xlsx";
	// public static final String TEST_FILE_NAME_WRITE =
	// "target/test-data-write.xlsx";
	//
